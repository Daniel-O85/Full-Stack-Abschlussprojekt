...
// Funktionskomponente für Backen
export default function Backen() {
    ...
    function suchen(begriff) {
        readJSONFromServer(
            `http://localhost:8899/backen/finden/${begriff}`,
            (respond) => {
    ...
    function bearbeiten(rezeptNr) {
        setBearbeitungsModus((prevModus) => {
            ...
            // Wenn der Bearbeitungsmodus beendet wird, setze die aktualisierten Daten zurück
    ...
    function zumRezept(nummer) {
        ...
        readJSONFromServer(
            `http://localhost:8899/backen/anzeigen/${nummer}`,
            (respond) => {
                const daten = respond.map((row) => {
                            ...
                            {bearbeitungsModus[row.RezeptNr] ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <option value={"Backen"} selected>Backen</option>
    ...
    function alleRezepte() {
        ...
        readJSONFromServer(`http://localhost:8899/backen/alleAnzeigen`, (respond) => {
            const daten = respond.map((row) => (
