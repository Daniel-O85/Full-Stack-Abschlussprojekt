...
// Funktionskomponente für Soßen
export default function Sossen() {
    ...
    function suchen(begriff) {
        readJSONFromServer(
            `http://localhost:8899/sossen/finden/${begriff}`,
            (respond) => {
    ...
    function zumRezept(nummer) {
        ...
        readJSONFromServer(
            `http://localhost:8899/sossen/anzeigen/${nummer}`,
            (respond) => {
                const daten = respond.map((row) => {
                            ...
                            {bearbeitungsModus[row.RezeptNr] ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <option value={"Sose"} selected>Soße</option>
    ...
    function alleRezepte() {
        ...
        readJSONFromServer(`http://localhost:8899/sossen/alleAnzeigen`, (respond) => {
            const daten = respond.map((row) => (
