...
// Funktionskomponente für Beilagen
export default function Beilagen() {
    ...
    function suchen(begriff) {
        readJSONFromServer(
            `http://localhost:8899/beilagen/finden/${begriff}`,
            (respond) => {
    ...
    function zumRezept(nummer) {
        ...
        readJSONFromServer(
            `http://localhost:8899/beilagen/anzeigen/${nummer}`,
            (respond) => {
                const daten = respond.map((row) => {
                            ...
                            {bearbeitungsModus[row.RezeptNr] ? (
                                <>
                                    ...
                                    >
                                        ...
                                        <option value={"Beilage"} selected>Beilage</option>
                                    </select>
                                    <br />
                                    <textarea
                                        id="zutatenInput"
    ...
    function alleRezepte() {
        ...
        readJSONFromServer(`http://localhost:8899/beilagen/alleAnzeigen`, (respond) => {
            const daten = respond.map((row) => (
